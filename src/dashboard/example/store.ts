import { replicantModule, ReplicantModule, ReplicantTypes } from '@klonoa_wahoo_allstar_speedrun_layouts/browser_shared/replicant_store';
import { ExampleReplicant } from '@klonoa_wahoo_allstar_speedrun_layouts/types/schemas';
